...
class NodeCrawler extends events_1.EventEmitter {
    ...
    _readOperationalLimits(callback) {
        ...
        this.session.read(nodesToRead, (err, dataValues) => {
            ...
            if (dataValues[0].statusCode.equals(node_opcua_status_code_1.StatusCodes.Good)) {
            ...
            if (dataValues[1].statusCode.equals(node_opcua_status_code_1.StatusCodes.Good)) {
    ...
    _process_single_browseResult(_objectToBrowse, browseResult) {
        ...
        const tmp = browseResult.references.filter((x) => node_opcua_nodeid_1.sameNodeId(x.referenceTypeId, hasTypeDefinitionNodeId));
        if (tmp.length) {
