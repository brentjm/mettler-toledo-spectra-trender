...
export declare class OPCUAClientImpl extends ClientBaseImpl implements OPCUAClient {
     ...
     * @method withSession
     */
    withSession<T>(endpointUrl: string, inner_func: (session: ClientSession) => Promise<T>): Promise<T>;
    withSession(endpointUrl: string, inner_func: (session: ClientSession, done: (err?: Error) => void) => void, callback: (err?: Error) => void): void;
    withSubscription(endpointUrl: string, subscriptionParameters: ClientSubscriptionOptions, innerFunc: (session: ClientSession, subscription: ClientSubscription, done: (err?: Error) => void) => void, callback: (err?: Error) => void): void;
