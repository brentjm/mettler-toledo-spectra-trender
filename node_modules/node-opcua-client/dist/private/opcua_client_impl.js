...
class OPCUAClientImpl extends client_base_impl_1.ClientBaseImpl {
    ...
    withSession(...args) {
        ...
        async.series([
            ...
            (innerCallback) => {
                this.createSession((err, session) => {
                    if (err) {
    ...
    withSessionAsync(endpointUrl, func) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const session = yield this.createSession({ type: node_opcua_service_endpoints_1.UserTokenType.Anonymous });
                let result;
                try {
    ...
    withSubscriptionAsync(endpointUrl, parameters, func) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.withSessionAsync(endpointUrl, (session) => __awaiter(this, void 0, void 0, function* () {
