...
class UANamespace {
    constructor(options) {
        ...
        node_opcua_assert_1.assert(options.addressSpace.constructor.name === "AddressSpace");
    ...
    createDataType(options) {
        node_opcua_assert_1.assert(!options.hasOwnProperty("addressSpace"));
    ...
    addYArrayItem(options) {
        ...
        variable.setValueFromSource(options.value, node_opcua_basic_types_1.StatusCodes.Good);
