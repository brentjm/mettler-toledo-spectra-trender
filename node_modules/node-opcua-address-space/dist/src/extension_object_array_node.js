...
function makeStructure(dataType, bForce) {
    ...
    if (!bForce && (node_opcua_factory_2.hasConstructor(dataType.binaryEncodingNodeId) || dataType.binaryEncodingNodeId.namespace === 0)) {
        return node_opcua_factory_2.getConstructor(dataType.binaryEncodingNodeId);
    }
    // etc ..... please fix me
...
function addElement(options /* ExtensionObjectConstructor | ExtensionObject | UAVariable*/, uaArrayVariableNode) {
    ...
    node_opcua_assert_1.assert(checkValue.statusCode === node_opcua_status_code_1.StatusCodes.Good);
    node_opcua_assert_1.assert(checkValue.value.dataType === node_opcua_variant_2.DataType.ExtensionObject);
    const addressSpace = uaArrayVariableNode.addressSpace;
