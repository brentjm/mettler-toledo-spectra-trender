...
class ConditionSnapshot extends events_1.EventEmitter {
    ...
    getConfirmedState() {
        node_opcua_assert_1.assert(this.condition.confirmedState, "Must have a confirmed state");
    ...
    setConfirmedState(confirmedState) {
        node_opcua_assert_1.assert(this.condition.confirmedState, "Must have a confirmed state.  Add ConfirmedState to the optionals");
