...
function _unshelve_method(inputArguments, context, callback) {
    ...
    if (shelvingState.getCurrentState() === "Unshelved") {
        return callback(null, {
            statusCode: node_opcua_constants_1.StatusCodes.BadConditionNotShelved
        });
    }
    ...
    return callback(null, {
        statusCode: node_opcua_constants_1.StatusCodes.Good
    });
}
...
function _timedShelve_method(inputArguments, context, callback) {
    ...
    if (shelvingState.getCurrentState() !== "Unshelved") {
        return callback(null, {
            statusCode: node_opcua_constants_1.StatusCodes.BadConditionAlreadyShelved
        });
    }
    // checking duration ...
    ...
    if (!(alarmNode instanceof ua_alarm_condition_base_1.UAAlarmConditionBase)) {
        return callback(null, {
            statusCode: node_opcua_constants_1.StatusCodes.BadNodeIdInvalid
        });
    }
    ...
    if (proposedDuration > maxTimeShelved) {
        return callback(null, {
            statusCode: node_opcua_constants_1.StatusCodes.BadShelvingTimeOutOfRange
        });
    }
...
function _unShelveTimeFunc(shelvingState) {
    if (shelvingState.getCurrentState() === "Unshelved") {
        return new node_opcua_variant_1.Variant({
            ...
            value: node_opcua_constants_1.StatusCodes.BadConditionNotShelved
        });
    }
