...
function VariableOrVariableType_toString(options) {
    ...
    if (this.dataType) {
        ...
        add(options.padding + chalk_1.default.yellow("                dataType: ") + this.dataType + "  " + n);
    }
    if (this.nodeClass === node_opcua_data_model_1.NodeClass.Variable) {
        if (this._dataValue) {
            add(options.padding + chalk_1.default.yellow("                   value: ") + "\n" +
                options.indent(this._dataValue.toString(), options.padding + "                        | "));
        }
    }
    if (this.accessLevel) {
        add(options.padding + chalk_1.default.yellow("             accessLevel: ") + " " +
            node_opcua_data_model_1.AccessLevelFlag[this.accessLevel]);
    }
    if (this.userAccessLevel) {
        add(options.padding + chalk_1.default.yellow("         userAccessLevel: ") + " " +
            node_opcua_data_model_1.AccessLevelFlag[this.userAccessLevel]);
    }
    if (this.hasOwnProperty("valueRank")) {
        add(options.padding + chalk_1.default.yellow("               valueRank: ") + " " +
            this.valueRank.toString());
    }
    if (this.minimumSamplingInterval !== undefined) {
        add(options.padding + chalk_1.default.yellow(" minimumSamplingInterval: ") + " " +
            this.minimumSamplingInterval.toString() + " ms");
    }
    add(options.padding + chalk_1.default.yellow("          references    : ") + "  length =" +
