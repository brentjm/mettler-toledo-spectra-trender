...
class UAVariable extends base_node_1.BaseNode {
    ...
    writeValue(context, dataValue, ...args) {
        ...
        this._timestamped_set_func(dataValue, indexRange, (err, statusCode1, correctedDataValue) => {
            if (!err) {
    ...
    bindVariable(options, overwrite) {
        ...
        options = options || {};
        node_opcua_assert_1.assert(!_.isFunction(this._timestamped_set_func), "UAVariable already bounded");
        node_opcua_assert_1.assert(!_.isFunction(this._timestamped_get_func), "UAVariable already bounded");
