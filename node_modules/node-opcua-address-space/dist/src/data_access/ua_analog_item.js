...
class UAAnalogItem extends ua_data_item_1.UADataItem {
    ...
    isValueInRange(value) {
        ...
        if (!this._validate_DataType(value.dataType)) {
            return node_opcua_constants_1.StatusCodes.BadTypeMismatch;
        }
        // AnalogDataItem
        if (this.instrumentRange) {
            if (!validate_value_range(this.instrumentRange.readValue().value.value, value)) {
                return node_opcua_constants_1.StatusCodes.BadOutOfRange;
            }
        }
        ...
        if (self.enumValues) {
            ...
            const e = enumValues.findIndex((x) => node_opcua_basic_types_1.coerceInt32(x.value) === node_opcua_basic_types_1.coerceInt32(value.value));
            if (e === -1) {
                return node_opcua_constants_1.StatusCodes.BadOutOfRange;
            }
        }
